    ...
    public class ChunkMesh
    {
        ...
        private float CalculateAO(bool side1, bool side2, bool corner)
        {
            ...
            switch (blockers)
            {
                ...
                case 1: return 0.7f;  // Один блокирующий блок - легкое затенение
                case 2: return 0.5f;  // Два блокирующих блока - среднее затенение
                case 3: return 0.2f;  // Три блокирующих блока - сильное затенение
                default: return 0.0f; // На всякий случай
            }
        }
